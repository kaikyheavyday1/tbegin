...
export default function Aboutus() {
    return (
        <div className = "aboutus text-center mt-4 mb-4">
           ...
           <img src = {Logo2} className="mt-2 mb-3" alt = "logo-first" width = "15%"/>
            <Row className = "bgaboutus justify-content-center">
            <Col lg = "8">
            <h2 className = "aboutus1 text-center mt-3">เกี่ยวกับเรา</h2>
            <h3 className = "text-left mt-3">เว็บไซต์ wwwafaadsf.com เป็นเว็บไซต์สำหรับนักเรียนและนักศึกษาที่มองหาการทำรายได้ ซึ่งผู้ที่ต้องการจะจ้างงานสามารถจ้างงานผ่านฟรีแลนซ์ที่เป็นนักเรียนและนักศึกษา ในส่วนราคาของการว่าจ้างขึ้นอยู่กับการสนทนากันระหว่างผู้ว่าจ้างและฟรีแลนซ์ 
